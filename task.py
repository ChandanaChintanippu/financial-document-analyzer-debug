...
financial_analysis_task = Task(
    description=(
        "Analyze the uploaded financial document carefully and provide a structured report.\n\n"
        "The analysis must include:\n"
        "1. Revenue Summary\n"
        "2. Profit / Loss Overview\n"
        "3. Key Financial Ratios (if available)\n"
        "4. Identified Risk Factors\n"
        "5. Investment Considerations\n\n"
        "Use ONLY information from the document.\n"
        "Do NOT fabricate data.\n"
        "Return the response in a structured, professional format."
    ),
    expected_output="A structured financial analysis report based strictly on document content.",
